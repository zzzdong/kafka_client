...
use crate::client::low_level::{KafkaClient as LowLevelClient, ClientConfig};
use crate::client::high_level::{Producer, ProducerConfig, Consumer, ConsumerConfig};
...
impl KafkaClientBuilder {
    ...
    pub fn with_sasl_plaintext(mut self, username: impl Into<String>, password: impl Into<String>) -> Self {
    ...
    pub fn with_sasl_ssl(mut self, domain: impl Into<String>, username: impl Into<String>, password: impl Into<String>) -> Self {
    ...
    pub fn with_sasl_scram_sha256(mut self, username: impl Into<String>, password: impl Into<String>) -> Self {
        self.sasl_credentials = Some(SaslCredentials {
    ...
    pub fn with_sasl_scram_sha512(mut self, username: impl Into<String>, password: impl Into<String>) -> Self {
        self.sasl_credentials = Some(SaslCredentials {
