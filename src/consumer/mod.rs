...
impl Consumer {
    ...
    async fn background_join_group(
        ...
        *coordinator.write().await = Some(coord_addr);
        ...
        Err(KafkaError::Protocol("JoinGroup retry exhausted".to_string()))
    }
    ...
    async fn do_commit(
        ...
        let response: Result<crate::protocol::OffsetCommitResponse> = cluster
            .send_to_broker(coordinator_addr, &request)
            .await;
