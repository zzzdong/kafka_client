...
// Producer types
pub use producer::{
    Header, PartitionRouting, PartitionRouter, Producer, ProducerConfig, ProducerRecord,
    RecordMetadata,
};
...
impl KafkaClientBuilder {
    ...
    pub fn with_tls(mut self, domain: impl Into<String>) -> Self {
        self.security_protocol = crate::transport::SecurityProtocol::Ssl(crate::transport::TlsConfig {
            domain: domain.into(),
            ..Default::default()
        });
        self
    ...
    pub fn with_sasl_ssl(
        ...
        self.with_sasl_tls(tls_config, crate::sasl::SaslMechanismType::Plain, username, password)
    }
